...
# ---------------------------------------------------------------------------
# Path setup: allow importing stage5 from services/stages without install
# ---------------------------------------------------------------------------
STAGES_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "services", "stages")
...
class TestEnrichmentAttemptCountOnFailure:
    ...
    def test_count_incremented_exactly_once_on_crawl_failure(self):
    ...
    def test_enrichment_failed_status_set_after_max_attempts(self):
    ...
    def test_retry_left_when_below_max_attempts(self):
