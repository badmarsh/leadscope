...
from wp_hunter.pivot_urlscan import (
    get_urlscan_api_key,
...
@pytest.mark.asyncio
@patch("wp_hunter.pivot_urlscan.httpx.AsyncClient.get")
...
@pytest.mark.asyncio
@patch("wp_hunter.pivot_urlscan.asyncio.sleep", new_callable=AsyncMock)
@patch("wp_hunter.pivot_urlscan.httpx.AsyncClient.get")
...
@patch("wp_hunter.pivot_urlscan.get_urlscan_api_key")
@patch("wp_hunter.pivot_urlscan.asyncio.run")
