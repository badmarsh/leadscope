...
from wp_hunter.pivot_vt import (
    get_vt_api_key,
    query_vt_file_hash,
...
@patch("wp_hunter.pivot_vt.httpx.Client.get")
...
@patch("wp_hunter.pivot_vt.time.sleep")
@patch("wp_hunter.pivot_vt.httpx.Client.get")
def test_query_vt_file_hash_429(mock_get, mock_sleep):
    ...
    res = query_vt_file_hash("abc", "key", _make_limiter(), max_retries=1)
    assert res["hash"] == "abc"
...
@patch("wp_hunter.pivot_vt.get_vt_api_key")
@patch("wp_hunter.pivot_vt.query_vt_file_hash")
@patch("wp_hunter.pivot_vt.query_vt_contacted_domains")
@patch("wp_hunter.pivot_vt.graph_walk_domain")
