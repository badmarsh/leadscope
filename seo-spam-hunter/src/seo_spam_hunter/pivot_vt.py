...
def query_vt_file_hash(
    ...
    """Query VirusTotal v3 GET /files/{hash} endpoint."""
    limiter.wait()
    headers = {"x-apikey": api_key, "User-Agent": "seo-spam-hunter/0.1.0"}
    ...
    with httpx.Client(timeout=30.0) as client:
        ...
        if res.status_code == 429:
            ...
            console.print("[yellow]VT Rate limit exceeded (429). Waiting 60s...[/yellow]")
            time.sleep(60.0)
            res = client.get(url, headers=headers)
