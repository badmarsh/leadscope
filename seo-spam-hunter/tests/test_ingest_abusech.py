...
import pytest
from seo_spam_hunter.ingest_abusech import fetch_urlhaus, fetch_threatfox, _extract_domain
...
def test_fetch_urlhaus_filters_wordpress_tags(tmp_path):
    ...
    with patch("seo_spam_hunter.ingest_abusech.httpx.Client") as mock_client:
